        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link link1 " href="index.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link2" href="kategorijaMobiteli.php">Mobiteli</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link1" href="kategorijaKonzole.php">Konzole</a>
                    </li>
                </ul>
            </div>
        </nav>
